...
/// <summary>
/// Contains unit tests for the Products entity class.
...
public class UserTests
{
    ...
    /// </summary>
    [Fact(DisplayName = "Products status should change to Active when activated")]
    ...
    /// </summary>
    [Fact(DisplayName = "Products status should change to Suspended when suspended")]
